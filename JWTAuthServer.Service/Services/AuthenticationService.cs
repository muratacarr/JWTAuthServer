...
namespace JWTAuthServer.Service.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public AuthenticationService(IGenericRepository<UserRefreshToken> userRefreshTokenService, IOptions<List<Client>> optionsClient, ITokenService tokenService, UserManager<UserApp> userManager, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<Response<TokenDto>> CreateTokenAsync(LoginDto loginDto)
        {
            ...
            {
                await _userRefreshTokenService.AddAsync(new UserRefreshToken { UserId = user.Id,Code=token.RefreshToken,Expriration=token.RefreshTokenExpiration });
            }
            else
            {
